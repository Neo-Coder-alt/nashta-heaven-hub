...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "New Master Nashta House — Nazimabad, Karachi" },
      { property: "og:description", content: "Karachi's beloved halwa puri nashta house. Crispy puris, flavorful chana, sweet halwa and hot chai." },
